 ...
 **********************************************************************/
void GPIO_config_input_nopull(volatile uint8_t *reg_name, uint8_t pin_num) // OK
{
    *reg_name = *reg_name & ~(1<<pin_num);
    reg_name++;
    *reg_name = *reg_name & ~(1<<pin_num);
 ...
 **********************************************************************/
void GPIO_write_high (volatile uint8_t *reg_name, uint8_t pin_num) // OK
{
    *reg_name = *reg_name | (1<<pin_num);
}
/**********************************************************************
 ...
 **********************************************************************/
void GPIO_toggle (volatile uint8_t *reg_name, uint8_t pin_num) // OK
{
    *reg_name = *reg_name ^ (1<<pin_num);
}
}
...
// if((*reg_name & (1 << pin_num)) == 0) return (0); //zpusob 2
//      return(1);

// return((*reg_num & (1 << pin_num)); //zpusob 3
}
}